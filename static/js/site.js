...
(function() {
  var Theory, bpm, bps, colorScale, enter, exercise, initInstrument, instrument, interval, major, makePromise, notes, parent, start, startId, timeline, update, w, xpos, _ref,
    __slice = [].slice;
