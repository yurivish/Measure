...
(function() {
  var Metronome, Theory, URL, audioContext, bpm, bps, cancelAnimationFrame, colorScale, d, enter, exercise, initInstrument, instrument, interval, major, makePromise, notes, parent, performance, requestAnimationFrame, start, startId, timeline, update, w, xpos, _d, _ref,
    __slice = [].slice;
