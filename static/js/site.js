...
(function() {
  var Metronome, Theory, URL, audioContext, bpm, bps, cancelAnimationFrame, colorScale, d, enter, exercise, initInstrument, instrument, interval, major, makePromise, notes, parent, requestAnimationFrame, start, startId, timeline, update, w, xpos, _d, _ref,
    __slice = [].slice;
  ...
  start = function(startTime) {
    var duration, endTime, error, notePlayed, timeToXAxis;
    ...
    instrument.on('keydown', function(e) {
      var index, nextNote, prevNote, selectedNote;
    ...
    Metronome.start(bpm);
    return setTimeout(Metronome.stop, duration);
  };

  instrument.fakeKeys(exercise.notes);

  startId = instrument.watch('keydown', function(e) {
    start(e.time);
