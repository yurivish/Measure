...
(function() {
  var ascending, descending, exercise, indicate, initInstrument, major, noteIndicator, notes, px, py, s, sel, visExercise, visSection, w, _ref,
    __slice = [].slice;
  ...
  visExercise = function(exercise) {
    ...
    pressed = function() {
      ...
      return note.select('text').transition().duration(400).ease('linear').attr('fill', '#000').attr('fill', '#333');
    };
